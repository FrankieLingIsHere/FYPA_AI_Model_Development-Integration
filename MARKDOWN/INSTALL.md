# 🚀 CASM Supabase Edition - Installation Guide
...
3. Fill in project details:
   - **Name**: `casm-ppe-monitor` (or your choice)
...
You should see the CASM Reports interface (initially empty).
...
**🌙 CASM Supabase Edition - You're all set!**
