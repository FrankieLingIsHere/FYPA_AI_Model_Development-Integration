...
- Local startup attempts (`start.bat` and direct `venv\\Scripts\\python.exe casm_app.py`) are currently exiting with code 1.
...
- High-risk areas:
  - `casm_app.py` (broad API/runtime behavior changes)
