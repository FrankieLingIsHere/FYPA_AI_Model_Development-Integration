...
Usage:
    python caption_image_llava.py path/to/image.jpg
"""
import sys
import torch
...
def caption_image_llava(image_path):
    ...
    # We use load_in_4bit=True to make it fit on consumer GPUs
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python caption_image_llava.py path/to/image.jpg")
        sys.exit(1)
