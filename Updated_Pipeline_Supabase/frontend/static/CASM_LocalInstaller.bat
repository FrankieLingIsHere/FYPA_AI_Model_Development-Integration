...
if not "!CASM_MACHINE_ID!"=="" if not "!CASM_PROVISION_SECRET!"=="" (
...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "$tokenMap = [ordered]@{ '__CASM_REPO_ZIP_URL__'='CASM_REPO_ZIP_URL'; '__CASM_SOURCE_ROOT__'='CASM_SOURCE_ROOT'; '__CASM_CLOUD_URL__'='CASM_CLOUD_URL'; '__CASM_INSTALLER_VERSION__'='CASM_INSTALLER_VERSION'; '__CASM_MACHINE_ID__'='CASM_MACHINE_ID'; '__CASM_PROVISION_SECRET__'='CASM_PROVISION_SECRET'; '__CASM_SUPABASE_URL__'='CASM_SUPABASE_URL'; '__CASM_SUPABASE_DB_URL__'='CASM_SUPABASE_DB_URL'; '__CASM_SUPABASE_SERVICE_ROLE_KEY__'='CASM_SUPABASE_SERVICE_ROLE_KEY' }; " ^
