...
class ReportRoutingStaticTest(unittest.TestCase):
    ...
    def test_local_sync_and_generation_quality_guards(self):
        ...
        self.assertIn('CASM_ALLOW_SYNTHETIC_REPROCESS_PLACEHOLDER', casm_app)
        self.assertIn('and _allow_synthetic_reprocess_placeholder_artifacts()', casm_app)
        self.assertIn("'missing_original_image'", casm_app)
        self.assertIn('Report artifact is fallback/placeholder output', casm_app)
        self.assertIn("'this placeholder was produced'", casm_app)
        self.assertIn("'casm reprocess placeholder'", casm_app)
        self.assertIn('forceReprocessActive', reports_js)
        self.assertIn("'missing_original_image'", reports_js)
        self.assertIn('force_status_downgrade: !!options.force', reports_js)
