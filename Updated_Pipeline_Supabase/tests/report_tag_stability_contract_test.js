...
function testMergeMatrix() {
  ...
  const cases = [
    ...
    {
      name: 'shared report survives cloud pending row during reconnect',
      base: [{
        report_id: 'tag-shared-pending-001',
        timestamp: now,
        status: 'completed',
        has_report: true,
        report_html_key: 'violations/tag-shared-pending-001/report.html',
        source_scope: 'shared',
        source_label: 'Shared',
      }],
      pending: [{
    ...
    {
      name: 'cloud report survives completed local filesystem mirror row',
      base: [{
        report_id: 'tag-cloud-local-mirror-001',
        timestamp: now,
        status: 'completed',
        has_report: true,
        report_html_key: 'violations/tag-cloud-local-mirror-001/report.html',
        source_scope: 'cloud',
        source_label: 'Cloud',
      }],
      pending: [{
    ...
    {
      name: 'local synced report survives completed local filesystem mirror row',
      base: [{
        report_id: 'tag-synced-local-mirror-001',
        timestamp: now,
        status: 'completed',
        has_report: true,
        report_html_key: 'violations/tag-synced-local-mirror-001/report.html',
        source_scope: 'synced_local',
        source_label: 'Local Synced',
        origin: 'local_synced',
        sync_source: 'sync_local_cache',
    ...
    {
      name: 'polluted cached cloud row repairs label from local to cloud',
      base: [{
        report_id: 'tag-polluted-cloud-001',
        timestamp: now,
        status: 'completed',
        has_report: true,
        report_html_key: 'violations/tag-polluted-cloud-001/report.html',
        source_scope: 'local',
        source_label: 'Local',
      }],
      pending: [],
...
function testRuntimePatchMatrix() {
  ...
  const cases = [
    ...
    {
      name: 'shared report stays shared when cloud reconnect snapshot arrives',
      existing: {
        report_id: 'tag-shared-cloud-runtime-001',
        status: 'completed',
        has_report: true,
        report_html_key: 'violations/tag-shared-cloud-runtime-001/report.html',
        source_scope: 'shared',
        source_label: 'Shared',
      },
      patch: {
    ...
    {
      name: 'completed cloud report ignores completed local filesystem runtime patch',
      existing: {
        report_id: 'tag-cloud-runtime-local-mirror-001',
        status: 'completed',
        has_report: true,
        report_html_key: 'violations/tag-cloud-runtime-local-mirror-001/report.html',
        source_scope: 'cloud',
        source_label: 'Cloud',
      },
      patch: {
    ...
    {
      name: 'completed local synced report ignores completed local filesystem runtime patch',
      existing: {
        report_id: 'tag-synced-runtime-local-mirror-001',
        status: 'completed',
        has_report: true,
        report_html_key: 'violations/tag-synced-runtime-local-mirror-001/report.html',
        source_scope: 'synced_local',
        source_label: 'Local Synced',
        origin: 'local_synced',
        sync_source: 'sync_local_cache',
